...
using _19_TPHInheritenceInEF_CFA.Contexts;
using _19_TPHInheritenceInEF_CFA.EntityModels;

namespace _19_TPHInheritenceInEF_CFA.Controllers
{
    public class ContractEmployeesController : Controller
    {
        ...
        {
            return View(db.Employees.OfType<ContractEmployee>().ToList());
        }
        ...
        public ActionResult Create([Bind(Include = "ID,FirstName,LastName,Gender,HoursWorked,HourlyPay")] ContractEmployee contractEmployee)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ID,FirstName,LastName,Gender,HoursWorked,HourlyPay")] ContractEmployee contractEmployee)
        {
            if (ModelState.IsValid)
            {
