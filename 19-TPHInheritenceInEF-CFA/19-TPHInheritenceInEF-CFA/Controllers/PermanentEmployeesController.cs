...
namespace _19_TPHInheritenceInEF_CFA.Controllers
{
    public class PermanentEmployeesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "ID,FirstName,LastName,Gender,AnnualSalary")] PermanentEmployee permanentEmployee)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ID,FirstName,LastName,Gender,AnnualSalary")] PermanentEmployee permanentEmployee)
        {
            if (ModelState.IsValid)
            {
