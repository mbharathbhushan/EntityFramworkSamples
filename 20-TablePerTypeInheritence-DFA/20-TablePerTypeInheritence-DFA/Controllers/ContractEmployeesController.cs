...
namespace _20_TablePerTypeInheritence_DFA.Controllers
{
    public class ContractEmployeesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "EmployeeID,FirstName,LastName,Gender,HourlyPay,HoursWorked")] ContractEmployee contractEmployee)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "EmployeeID,FirstName,LastName,Gender,HourlyPay,HoursWorked")] ContractEmployee contractEmployee)
        {
            if (ModelState.IsValid)
            {
